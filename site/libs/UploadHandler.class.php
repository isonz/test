 ...
 * $options = array(
		'upload_dir'	=> 'upload',
		'upload_url'	=> '/public/files/?op=view&file=',
		'deleteUrl'		=> '/public/files/?op=delete&',
		'image_versions'=> array(),
		'filename'	=> 'YmdHis'.rand(1000, 9999),
		'param_name'	=> $param_name,		//提交 input 的名称
...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            */
        	...
        	'deleteUrl' => $this->options['script_url'].$this->get_query_separator($this->options['script_url'])
        );
        if ($options) {
    ...
    protected function set_additional_file_properties($file) {
        ...
        */
        $file->deleteUrl = $this->options['deleteUrl'].$this->get_singular_param_name().'='.rawurlencode($file->name);
    ...
    public function post($print_response = true) {
        ...
        $files = array();
        //$file_name =  $file_name ? $file_name : $this->options['filename'];
        $file_name =  $this->options['filename'] ? $this->options['filename'] : $file_name;
